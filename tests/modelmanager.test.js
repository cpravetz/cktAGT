...
describe('ModelManager_class', () => {
    ...
    it("test_active_model_set_correctly", () => {
        process.env.DEFAULT_MODEL = "testModel";
        const modelManager = new ModelManager();
        expect(modelManager.activeModel.name).toEqual("testModel");
    });
    ...
    // Tests that keyMaker generates unique IDs. 
    it("test_keymaker_generates_unique_ids", () => {
        const id1 = keyMaker();
        const id2 = keyMaker();
    ...
    it("test_get_model_returns_correct_model", () => {
        const modelManager = new ModelManager();
        const testModel = modelManager.getModel("testModel");
        expect(testModel.name).toEqual("testModel");
    });
});
